...
$(function () {
  ...
  console.log('%c Mashiro %c', 'background:#24272A; color:#ffffff', '', 'http://www.vertx.top/')
  console.log('%c hojun %c', 'background:#24272A; color:#ffffff', '', 'http://www.vertx.top/')
  console.log('%c Github %c', 'background:#24272A; color:#ffffff', '', 'http://www.vertx.top/')
})
